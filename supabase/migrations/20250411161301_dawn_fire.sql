/*
  # Fix unit conversion calculations

  1. Changes
    - Update recipe_with_ingredients view to correctly calculate nutritional values
    - Fix conversion factor calculation to multiply base quantity by custom unit factor
    
  2. View Structure
    - All fields from recipes table
    - Correctly calculated nutritional values using base_quantity * conversion_factor
