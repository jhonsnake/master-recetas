/*
  # Fix recipe calculations and unit conversions

  1. Changes
    - Update recipe_with_ingredients view to correctly calculate nutritional values
    - Fix unit conversion text to show proper equivalences
    - Simplify conversion calculations
    
  2. Details
    - When using custom units, multiply quantity by conversion factor to get base unit amount
    - Update conversion text to show proper equivalence
    - Fix nutritional calculations based on converted quantities
*/
